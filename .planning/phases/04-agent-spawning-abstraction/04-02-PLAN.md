...
**First, check the current implementation location:**
Locate the existing spawnAgent() method (should be around line 164 based on prior knowledge, but verify actual state).
