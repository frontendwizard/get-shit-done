...
# Test dry-run (without actually installing)
# Verify adapter creation doesn't crash
...
```
  ...
  <done>install.js uses adapter.registerHook for hooks, compiles without errors, syntax validates, async/await present</done>
</task>
