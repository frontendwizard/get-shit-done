...
11. **Verify directories are created (INST-02):**
```bash
# After fresh install, verify all directories exist
ls -la ~/.claude/commands/gsd
ls -la ~/.claude/agents/gsd
ls -la ~/.claude/hooks
...
11a. **Test non-interactive mode (INST-06):**
```bash
# Test non-interactive installation
echo | node bin/install.js --global
...
- [ ] Directories created correctly (INST-02 verified)
- [ ] Non-interactive mode works (INST-06 verified)
  </how-to-verify>
...
- [ ] Human verified directories created (INST-02)
- [ ] Human verified non-interactive mode works (INST-06)
