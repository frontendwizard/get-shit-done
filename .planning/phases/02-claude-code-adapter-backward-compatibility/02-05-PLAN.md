...
must_haves:
  truths:
    - Existing Claude Code users can upgrade from v1.x to v2.x without breaking
    - All 24 slash commands execute identically to pre-refactor behavior
    - Active .planning/ projects continue working after upgrade
    - settings.json format is identical to v1.x (hooks, formatting, structure)
  artifacts:
