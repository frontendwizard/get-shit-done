...
<task type="auto">
  <name>Task 2: Implement hook and command registration</name>
  <files>src/platform/adapters/claude-code.ts</files>
  <action>
...
```
  ...
  <done>All PlatformAdapter interface methods implemented, TypeScript compiles without interface errors</done>
</task>
...
- [ ] Command registration detects collisions (INST-03 satisfied, used in Phase 3)
