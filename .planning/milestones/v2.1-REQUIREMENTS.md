# Requirements Archive: v2.1 Platform Documentation
...
Requirements for v2.1 milestone. All completed.
...
- [x] **GUIDE-02**: Registration checklist documenting 5-file changes required to add a platform
...
Tracked but not in v2.1 scope. Consider for future milestones.
...
---
*Requirements archived: 2026-01-22*
*Milestone: v2.1 Platform Documentation shipped*
